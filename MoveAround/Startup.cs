...
namespace MoveAround
{
    public class Startup
    {
         ...
         public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.AddPolicy("Useriai", policy => policy.RequireRole("Users"));
            });
  ...
  .AddFluentValidation(fv => fv.RegisterValidatorsFromAssemblyContaining<TransportValidator>());
            ...
            //Kad atnaujintu cokius ir roles
