...
namespace MoveAround.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "Slaptažodžio laukas yra privalomas")]
            [StringLength(100, ErrorMessage = " {0}turi būti nuo {2} iki {1} simbolių ilgio", MinimumLength = 6)]
            [DataType(DataType.Password)]
            ...
            [Compare("NewPassword", ErrorMessage = "Slaptažodžiai netutampa.")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Slaptažodis pakeistas sįkmingai";
